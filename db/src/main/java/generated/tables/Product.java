...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, Integer> AMOUNT = createField(DSL.name("amount"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.product.organization</code>.
     */
    public final TableField<ProductRecord, String> ORGANIZATION = createField(DSL.name("organization"), SQLDataType.VARCHAR, this, "");
    ...
    public List<ForeignKey<ProductRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PRODUCT__PRODUCT_ORG_FK);
    }
    ...
    public Organization organization() {
        if (_organization == null)
            _organization = new Organization(this, Keys.PRODUCT__PRODUCT_ORG_FK);
